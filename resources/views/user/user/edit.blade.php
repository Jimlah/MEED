...
@section('body')
    ...
    <div class="static">
        <div class="absolute right-0 flex flex-col items-start mr-5 space-y-2">
            <div
                ...
                <div class="flex items-center justify-between space-x-3">
                    ...
                    <span class="font-semibold blur-sm">
                        You have successfull added a new user
                    </span>
                </div>
                <span>
            ...
            <div
                ...
                <div class="flex items-center justify-between space-x-3">
                    ...
                    <span class="font-semibold blur-sm">
                        You recieved a new notification
                    </span>
                </div>
                <span>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
            ...
            <div
                ...
                <div class="flex items-center justify-between space-x-3">
                    <span class="p-1 bg-yellow-500 rounded-2xl">
                        <svg class="w-8 h-8 text-yellow-500 " fill="#FFFFFF" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="font-semibold blur-sm">
                        You do not have access to perform such action
                    </span>
                </div>
                <span>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
